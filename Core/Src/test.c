...
//���ƹ̶���up
//LCD_Clear(WHITE);
LCD_Fill(0,0,lcddev.width,40,BRED);
//���ƹ̶���down
LCD_Fill(0,lcddev.height-20,lcddev.width,lcddev.height,BRED);
POINT_COLOR=WHITE;
Set_Text_colour(WHITE);
Set_Text_Mode(1);
Set_Text_Back_colour(BRED);
Set_Text_Size(4);
lcd_Print_String(str, CENTER, 4);
//Gui_StrCenter(0,2,WHITE,BLUE,str,16,1);//������ʾ
Gui_StrCenter(0,lcddev.height-18,WHITE,BRED,"http://www.nidaas.com",16,1);//������ʾ
//���Ʋ�������
...
void main_test(void)
{
	...
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2018-10-25",16,1);//������ʾ
	delay_ms(1500);		
	delay_ms(1500);
}
...
void Test_Color(void)
{
	...
	Show_Str(20,30,BLUE,YELLOW,"BL Test",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height,RED);
	Show_Str(20,30,BLUE,YELLOW,"RED ",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height,GREEN);
	Show_Str(20,30,BLUE,YELLOW,"GREEN ",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height,BLUE);
	Show_Str(20,30,RED,YELLOW,"BLUE ",16,1);delay_ms(500);
}
